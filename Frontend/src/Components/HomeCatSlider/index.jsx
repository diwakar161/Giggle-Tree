          ...
          <SwiperSlide>
            <Link to="/">
              <div className="item p-3 bg-white rounded-sm text-center flex flex-col items-center justify-center min-h-[110px] w-full">
                ...
                <h3 className="text-[13px] font-normal mt-2">Fashion</h3>
              </div>
            </Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link to="/">
              <div className="item p-3 bg-white rounded-sm text-center flex flex-col items-center justify-center min-h-[110px] w-full">
                ...
                <h3 className="text-[13px] font-normal mt-2">Electronics</h3>
              </div>
            </Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link to="/">
              <div className="item p-3 bg-white rounded-sm text-center flex flex-col items-center justify-center min-h-[110px] w-full">
                ...
                <h3 className="text-[13px] font-normal mt-2">Bags</h3>
              </div>
            </Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link to="/">
              <div className="item p-3 bg-white rounded-sm text-center flex flex-col items-center justify-center min-h-[110px] w-full">
                ...
                <h3 className="text-[13px] font-normal mt-2">Footwear</h3>
              </div>
            </Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link to="/">
              <div className="item p-3 bg-white rounded-sm text-center flex flex-col items-center justify-center min-h-[110px] w-full">
                ...
                <h3 className="text-[13px] font-normal mt-2">Groceries</h3>
              </div>
            </Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link to="/">
              <div className="item p-3 bg-white rounded-sm text-center flex flex-col items-center justify-center min-h-[110px] w-full">
                ...
                <h3 className="text-[13px] font-normal mt-2">Beauty</h3>
              </div>
            </Link>
          </SwiperSlide>
          <SwiperSlide>
